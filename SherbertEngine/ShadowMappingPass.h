...
namespace Rgph
{
	...
	public:
		...
		void Execute( Graphics& gfx ) const noxnd override
		{
			...
			// Using a buffer temp as otherwise we run into C2102 errors:
			// This is because &pShadowCamera->GetPos() returns a unnamed temporary object (int pointer).
			// It is meaningless to get its address since it will most likely be invalid after expression ends.
			const auto tempPos = &pShadowCamera->GetPos();
