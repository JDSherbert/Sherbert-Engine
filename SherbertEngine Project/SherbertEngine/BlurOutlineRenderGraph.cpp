...
namespace n_SherbRendergraphpass
{
	...
	void n_SherbRendergraphpass::BlurOutlineRenderGraph::RenderShadowWindow( Graphics& gfx )
	{
	...
	void n_SherbRendergraphpass::BlurOutlineRenderGraph::BindMainCamera( Camera& cam )
	{
	...
	void n_SherbRendergraphpass::BlurOutlineRenderGraph::BindShadowCamera( Camera& cam )
	{
	...
	void n_SherbRendergraphpass::BlurOutlineRenderGraph::DumpShadowMap( Graphics& gfx,const std::string& path )
	{
