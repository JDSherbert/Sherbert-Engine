...
{
	return "SherbertEngine Graphics Exception";
}
...
{
	return "SherbertEngine Graphics Exception [Device Removed] (DXGI_ERROR_DEVICE_REMOVED)";
}
...
{
	return "SherbertEngine Graphics Info Exception";
}
