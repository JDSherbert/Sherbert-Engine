...
void Model::LinkTechniques( n_SherbRendergraphpass::RenderGraph& rg )
{
...
void Model::Rotate(float dx, float dy) noexcept
{
}

void Model::Translate(DirectX::XMFLOAT3 translation) noexcept
{
}
