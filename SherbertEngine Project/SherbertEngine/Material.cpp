	...
	modelPath( path.string() )
{
	...
	// phong technique
	{
		Technique phong{ "Phong",n_SherbRenderChannels::main };
	...
	// outline technique
	{
		Technique outline{ "Outline",n_SherbRenderChannels::main,false };
		{
	...
	{
		Technique map{ "ShadowMap",n_SherbRenderChannels::shadow,true };
		{
			Step draw( "shadowMap" );
